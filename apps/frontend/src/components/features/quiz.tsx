...
export function Quiz() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="fixed bottom-8 left-0 right-0 flex justify-between items-center px-8 max-w-3xl mx-auto">
        <Button
          variant="outline"
          onClick={() => {
          ...
          className="px-6 py-2 text-primary bg-white hover:bg-gray-50 border-gray-300"
        >
